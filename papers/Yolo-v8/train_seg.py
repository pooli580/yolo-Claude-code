...
from ultralytics.yolo.utils import DEFAULT_CFG, RANK, FILE
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError('ERROR ❌ segment dataset incorrectly formatted or not a segment dataset.\n'
                            ...
                            "correctly formatted 'segment' dataset using 'data=xianyinggun.yaml' "
...
def train(cfg=DEFAULT_CFG, use_python=False):
    ...
    data = cfg.data or 'xianyinggun.yaml'  # or yolo.ClassificationDataset("mnist")
    # model = 'yolov8n-seg.pt'
    # data = 'xianyinggun.yaml'  # or yolo.ClassificationDataset("mnist")
